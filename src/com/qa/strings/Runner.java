...
//		StringsExercise splitting = new StringsExercise();
//		splitting.methodOne("Hello world A");
//		
		StringsExercise v = new StringsExercise();
		

		
		   // can use replace " " with " /n " to print it our vertically
		v.methodTwo("Hello world");
	}
